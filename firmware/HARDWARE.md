...
> **注意**: チルトのデフォルトは GPIO7 で I2C SDA と衝突する。
> I2C を使う場合は `menuconfig` で別の GPIO に変更すること。
...
```
GPIO 0-6, 20-27, 32-33, 36-38, 45-48
```
...
2. **スピーカー**: MX1.25 コネクタに 8Ω 2W スピーカーを接続
