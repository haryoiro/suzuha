...
func (h *AdminHandler) ConversationLogsList(ctx context.Context) (*api.ConversationLogsListOK, error) {
	...
	var data []api.ConversationSummary
	for rows.Next() {
		var s api.ConversationSummary
	...
	if data == nil {
		data = []api.ConversationSummary{}
	}
	return &api.ConversationLogsListOK{Data: data}, nil
}

func (h *AdminHandler) ConversationLogsExport(ctx context.Context, params api.ConversationLogsExportParams) (api.ConversationLogsExportOK, error) {
	...
	return api.ConversationLogsExportOK{Data: &buf}, nil
}
