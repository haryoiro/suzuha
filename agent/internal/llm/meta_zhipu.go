...
var knownZhipuModels = []ModelInfo{
	{ModelID: "glm-4.7", Capabilities: []string{"text"}, MaxContext: 128000},
	{ModelID: "glm-5.1", Capabilities: []string{"text"}, MaxContext: 32000},
	{ModelID: "glm-4-flash", Capabilities: []string{"text"}, MaxContext: 128000},
	{ModelID: "glm-4v-plus", Capabilities: []string{"text", "vision"}, MaxContext: 32000},
