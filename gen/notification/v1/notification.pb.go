...
type SendMessageRequest struct {
	...
	ChannelId        string                 `protobuf:"bytes,1,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty"`                          // Discord channel ID
	Content          string                 `protobuf:"bytes,2,opt,name=content,proto3" json:"content,omitempty"`                                               // Message text (supports Discord markdown)
	Source           string                 `protobuf:"bytes,3,opt,name=source,proto3" json:"source,omitempty"`                                                 // Origin label, e.g. "rss", "todo_reminder"
	ReplyToMessageId string                 `protobuf:"bytes,4,opt,name=reply_to_message_id,json=replyToMessageId,proto3" json:"reply_to_message_id,omitempty"` // Optional: reply to this platform message ID
...
type SendMessageResponse struct {
	...
	MessageId     string                 `protobuf:"bytes,2,opt,name=message_id,json=messageId,proto3" json:"message_id,omitempty"` // Discord message ID if successful
...
const file_proto_notification_v1_notification_proto_rawDesc = "" +
	"\n" +
	"(proto/notification/v1/notification.proto\x12\x0fnotification.v1\"\x94\x01\n" +
	"\x12SendMessageRequest\x12\x1d\n" +
	"\n" +
	"channel_id\x18\x01 \x01(\tR\tchannelId\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent\x12\x16\n" +
	"\x06source\x18\x03 \x01(\tR\x06source\x12-\n" +
	"\x13reply_to_message_id\x18\x04 \x01(\tR\x10replyToMessageId\"Z\n" +
	...
	"\vSendMessage\x12#.notification.v1.SendMessageRequest\x1a$.notification.v1.SendMessageResponseB?Z=github.com/haryoiro/suzuha/gen/notification/v1;notificationv1b\x06proto3"
...
var file_proto_notification_v1_notification_proto_goTypes = []any{
	(*SendMessageRequest)(nil),  // 0: notification.v1.SendMessageRequest
	(*SendMessageResponse)(nil), // 1: notification.v1.SendMessageResponse
}
var file_proto_notification_v1_notification_proto_depIdxs = []int32{
	0, // 0: notification.v1.NotificationService.SendMessage:input_type -> notification.v1.SendMessageRequest
	1, // 1: notification.v1.NotificationService.SendMessage:output_type -> notification.v1.SendMessageResponse
